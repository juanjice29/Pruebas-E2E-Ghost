...
@user1 @web
Scenario: Con mi usuario de ghost quiero crear un post y asignarlo a un tag
    ...
    And I wait for 1 seconds
    And I click post tags
    And I wait for 1 seconds
    And I click post tag
    And I wait for 1 seconds
    And I click close post settings
    And I wait for 1 seconds
    And I click publish post
    And I wait for 1 seconds
    And I select scheduled post publish option
    And I wait for 1 seconds
